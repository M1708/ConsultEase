      ...
      <div className="h-screen bg-gray-100 overflow-hidden">
        ...
        <div className="flex h-[calc(100vh-4rem)] overflow-hidden">
          ...
          <div 
            ...
            style={{ width: `${leftPanelWidth}px`, minWidth: '250px', maxWidth: '500px' }}
          >
            {/* User Name Section */}
            <div className="p-4 bg-blue-50 flex-shrink-0">
              <div className="flex items-center space-x-2">
                <div className="h-3 w-3 bg-green-500 rounded-full"></div>
                <h3 className="text-lg font-bold text-gray-900 truncate" style={{ fontFamily: 'Arial, sans-serif' }}>
              ...
              <div className="max-w-4xl mx-auto space-y-6 chat-messages">
                {messages.length === 0 ? (
                  <div className="text-center text-gray-500 mt-4">
                    <h3 className="text-lg font-semibold mb-2 text-gray-700" style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
                      Welcome to Effiscale Consulting
                    </h3>
                    <p className="text-gray-600" style={{ fontFamily: 'Arial, sans-serif' }}>
                      Ask me anything about your clients, contracts, time tracking, deliverables, or employees.
                    </p>
                  </div>
                ) : (
                  messages.map((msg) => (
                      ...
                      {msg.isUser ? (
                        <>
                          ...
                          <div className="max-w-md bg-blue-600 text-white px-4 py-3 rounded-lg shadow-md">
                            <div className="whitespace-pre-wrap text-base" style={{ fontFamily: 'Arial, sans-serif' }}>{msg.message}</div>
                        ...
                        <>
                          ...
                          <div className="max-w-md bg-white px-4 py-3 rounded-lg shadow-md">
                            <div className="mb-2">
                              <div className="text-xs font-bold text-gray-600" style={{ fontFamily: 'Arial, sans-serif' }}>
                ...
                {isTyping && (
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="max-w-md bg-white px-4 py-3 rounded-lg shadow-md">
                      <div className="flex items-center space-x-2">
                        <span className="text-base text-gray-600" style={{ fontFamily: 'Arial, sans-serif' }}>
