...
from backend.src.database.core.models import TimeEntry, Contract, Client
from backend.src.database.core.schemas import TimeEntryCreate, TimeEntryUpdate, TimeEntryResponse
...
def update_time_entry(
    ...
    db_time_entry.last_modified_by = "system"
    db_time_entry.last_modified_timestamp = func.now()
    db_time_entry.updated_by = "00000000-0000-0000-0000-000000000000"
    db.commit()
    db.refresh(db_time_entry)
    return db_time_entry
