"""
Simple test using the user ID directly to bypass authentication issues
"""
import requests
import json
import time
...
JWT_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFqbnNtY2Z5bmFha3J2c2RucnBzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQ1MzczMjMsImV4cCI6MjA3MDExMzMyM30.jtF5-4S8AGdp8_iyt63u8Z5gEf-dnb72RBfvW25PoeI"

def test_api_endpoint(message: str, description: str):
    """Test a single API endpoint with proper JWT authentication"""
    print(f"\n=== {description} ===")
...
def main():
    """Run all API tests"""
    print("🧪 Testing FastAPI endpoints with user_id bypass...")
